%MMM_ASbaffledradzmatrixPrecompute : Precompute and save modal radiation impedance matrix
%
% MMM_ASbaffledradzmatrixPrecompute(kamin, kamax, nk, maxModes)
% 
% IMPORTANT: THIS FILE MUST BE RUN BEFORE RUNNING OTHER COMPUTATIONS
%
% Precomputes the modal radiation impedance matrix for the 
% end of a circular tube terminated in an infinite baffle
% by numerical interation and save it.
%
% The matrix Zmat is a square, symmetrical matrix. 
%
% To be used together with MMM_ASbaffledradzmatrixIntp.
%
% Input parameters:
% maxModes : maximum number of modes calculated (default: 64)
%
%  --------------------------------------------------- -------------------------------------------
...
function MMM_ASbaffledradzmatrixPrecompute(maxModes)
...
ka1 = logspace(log10(kamin), log10(3), 20);
